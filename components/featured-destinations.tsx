      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        ...
        <div className="mb-20 text-center">
          <h2 className="text-5xl md:text-6xl mb-6">
            <span className="products-gradient font-semibold">
              Наша продукція
            </span>
          </h2>
        ...
        <div className="space-y-8">
          <div className="p-8 rounded-2xl bg-card border border-border hover:shadow-xl transition duration-500">
            <h3 className="text-2xl mb-4">Сучасні технології</h3>
          ...
          <div className="p-8 rounded-2xl bg-card border border-border hover:shadow-xl transition duration-500">
            <h3 className="text-2xl mb-4">Ефективність та економія</h3>
            <p className="text-muted-foreground leading-relaxed text-lg">
          ...
          <div className="p-8 rounded-2xl bg-card border border-border hover:shadow-xl transition duration-500">
            <h3 className="text-2xl mb-4">Безпека та надійність</h3>
            <p className="text-muted-foreground leading-relaxed text-lg">
          ...
          <div className="p-8 rounded-2xl bg-gradient-to-r from-[#008000]/5 via-[#008000]/10 to-[#008000]/5 border border-border hover:shadow-2xl transition duration-500">
            <h3 className="text-2xl mb-4">Комфорт без зусиль</h3>
            <p className="text-muted-foreground leading-relaxed text-lg">
